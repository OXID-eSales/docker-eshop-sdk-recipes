...
$SCRIPT_PATH/../parts/shared/require.sh -n"oxid-professional-services/countryvatadministration" -g"https://github.com/OXID-eSales/country-vat-module.git" -v"dev-b-7.2.x"
...
docker compose exec -T php vendor/bin/oe-console oe:module:activate oecountryvat
...
perl -pi\
  ...
  -e 's#</component>#<mapping directory="\$PROJECT_DIR\$/source/vendor/oxid-professional-services/countryvatadministration" vcs="Git" />\n  </component>#g;'\
  .idea/vcs.xml
