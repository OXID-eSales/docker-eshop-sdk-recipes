...
$SCRIPT_PATH/../parts/shared/require.sh -n"oxid-esales/evat-module" -g"https://github.com/OXID-eSales/vat_tbe_services.git" -v"dev-b-7.2.x"
...
docker compose exec -T php vendor/bin/oe-console oe:module:activate oevattbe
...
perl -pi\
  ...
  -e 's#</component>#<mapping directory="\$PROJECT_DIR\$/source/vendor/oxid-esales/evat-module" vcs="Git" />\n  </component>#g;'\
  .idea/vcs.xml
