...
# Clone PayPal module to modules directory
git clone git@github.com:OXID-eSales/paypal.git --branch=b-6.4.x source/source/modules/oe/oepaypal
...
docker-compose exec -T php bin/oe-console oe:module:install-configuration source/modules/oe/oepaypal/
