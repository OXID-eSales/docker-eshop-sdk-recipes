...
$SCRIPT_PATH/../parts/shared/require_compilation.sh -e "ee" -m "b-8.0" -b "b-8.0.x"
...
$SCRIPT_PATH/../parts/shared/require.sh -n"oxid-esales/media-library-module" -g"https://github.com/OXID-eSales/media-library-module.git" -v"v1.0.0"
$SCRIPT_PATH/../parts/shared/require.sh -n"ddoe/wysiwyg-editor-module" -g"https://github.com/OXID-eSales/ddoe-wysiwyg-editor-module.git" -v"v4.0.0"
$SCRIPT_PATH/../parts/shared/require.sh -n"ddoe/visualcms-module" -g"https://github.com/OXID-eSales/visual_cms_module.git" -v"v5.0.1"

$SCRIPT_PATH/../parts/shared/require.sh -n"oxid-esales/gdpr-optin-module" -v"dev-b-8.0.x"
$SCRIPT_PATH/../parts/shared/require.sh -n"oxid-professional-services/usercentrics" -v"dev-b-8.0.x"
...
docker compose exec -T php vendor/bin/oe-console oe:module:activate eyeable_assist
