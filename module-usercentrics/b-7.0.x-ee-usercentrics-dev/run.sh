...
docker-compose exec php composer config repositories.oxid-esales/twig-theme git https://github.com/OXID-eSales/twig-theme.git
docker-compose exec php composer config repositories.oxid-esales/twig-admin-theme git https://github.com/OXID-eSales/twig-admin-theme.git
docker-compose exec php composer config repositories.oxid-esales/twig-component git https://github.com/OXID-eSales/twig-component.git
