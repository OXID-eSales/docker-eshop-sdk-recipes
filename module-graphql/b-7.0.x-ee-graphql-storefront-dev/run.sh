...
git clone git@github.com:OXID-eSales/graphql-base-module.git --branch=master source/source/modules/oe/graphql-base
git clone git@github.com:OXID-eSales/graphql-storefront-module.git --branch=master source/source/modules/oe/graphql-storefront
