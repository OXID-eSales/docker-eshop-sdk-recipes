...
$SCRIPT_PATH/../parts/shared/require.sh -n"oxid-esales/oxideshop-demodata-${edition_lower}" -g"https://github.com/OXID-eSales/oxideshop_demodata_${edition_lower}" -v"dev-master"
