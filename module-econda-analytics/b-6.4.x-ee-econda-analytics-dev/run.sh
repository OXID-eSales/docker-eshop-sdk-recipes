...
git clone https://github.com/OXID-eSales/econda-analytics-module.git --branch=b-6.3.x source/source/modules/oe/econdaanalytics
...
docker-compose exec -T \
  php composer config repositories.oxid-esales/econda-analytics-module \
  --json '{"type":"path", "url":"./source/modules/oe/econdaanalytics", "options": {"symlink": true}}'
docker-compose exec -T php composer require oxid-esales/econda-analytics-module:* --no-update

docker-compose exec -T php composer update --no-interaction
docker-compose exec -T php php vendor/bin/reset-shop

docker-compose exec -T php bin/oe-console oe:module:install-configuration source/modules/oe/econdaanalytics/
docker-compose exec -T php bin/oe-console oe:module:activate oeecondaanalytics
