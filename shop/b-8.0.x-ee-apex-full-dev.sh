...
"${SCRIPT_PATH}/../parts/b-8.0.x/start_shop.sh" -e"EE" -u"false"
"${SCRIPT_PATH}/../parts/shared/require_twig_components.sh" -e"EE" -b"b-8.0.x"

"${SCRIPT_PATH}/../parts/shared/require_theme.sh" -t"apex" -b"b-8.0.x"

"${SCRIPT_PATH}/../parts/shared/require_deprecated_tests_bundle.sh" -e"EE" -b"b-8.0.x"
